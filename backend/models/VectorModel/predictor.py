...
class Predictor:
    ...
    def __init__(self, data_path):
        self.eq_model = VectorModel(data_path + 'nctr_se_latex2vec.model', data_path + 'q_and_a_t2v_features.npy',
                                    TexTokenizer())
        self.text_model = WordVectorModel(data_path + 'se_w2v.model', data_path + 'q_and_a_w2v_features.npy',
